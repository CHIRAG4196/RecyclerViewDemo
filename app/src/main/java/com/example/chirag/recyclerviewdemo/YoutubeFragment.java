...
import com.example.chirag.recyclerviewdemo.Adapters.YoutubeAdapter;
...
public class YoutubeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRvYoutube = (RecyclerView) view.findViewById(R.id.rv_youtube);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        mRvYoutube.setLayoutManager(layoutManager);
        dummyData();

        YoutubeAdapter youtubeAdapter = new YoutubeAdapter(getActivity(),youtubeArrayList);
        mRvYoutube.setAdapter(youtubeAdapter);
    }
    private void dummyData() {
        for (int i = 0; i < 11; i++) {
            ...
            youtube.setYoutubeStream(+ random.nextInt(10) + "Years ago");
            youtube.setYoutubeOwner("Chirag Patel");
